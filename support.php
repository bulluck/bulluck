...
<div class="toitoi">
 <h2 class="toi1-1">《期間限定》開発費10％分のオプション無料券プレゼントキャンペーン実施中!
</h2> 
<div class="toi1-2">キャンペーン期間に、下記フォームよりメールorラインをご登録頂いた方に、もれなく開発額10%分のオプション無料券をプレゼント致します。
  <br>
  <br>
  例) キャンペーン期間にメールorラインにご登録いただき、開発費30万円分のご契約を頂いた場合、一年間ご利用いただける3万円(開発費の10%)のオプション無料券をプレゼント致します。
  
  <br><br>
    ぜひこの機会に投資のご検討してみてください。費用対効果は絶大です。※キャンペーンは予告無く終了する場合がございます。ご利用予定の方はお早めにご利用ください。
</div>
</div>
