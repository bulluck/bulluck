...
<section  id="achieves">
    <div class="wrapnormal">
        ...
        <div class="contentsbody">
          ...
          <div class="wrap-achieve-contents">
            <div class="achieve-img-box">
              <img src="<?php bloginfo('template_url');?>/images/HG-scsho.png" alt="実績画像1" />
            </div>
            ...
            <div class="achieve-text">
              <div class="boxhalf  arrow-left">
                <h5 class="achieve-headding">
                    ご相談の背景
                </h5>
                <p>
        ...
        <div class="contentsbody">
          <div class="small-case">
              ...
              <span class="tab-headding">Case.2</span>
              <div class="wrap-achieve-contents">
                  <h4 class="small-headding">
                    自社HPリニューアルにより販売台数が1.5倍に
                  </h4>
                  <p>
                    中古自動車販売業のお客様
                  </p>
                <div class="achieve-text">
                  ...
                  <div  class="arrow-down">
                    ...
                    <p>
                      お話をお伺いすると、VIPカーを専門に扱うという明確な自社の特色がありました。情報発信の質と量の双方を高めた自社HPリニューアルに着手しました。以前はポータルサイトからの問い合わせのみであったが、自社HPからのメール・電話を増やしました。
                    </p>
                  </div>
                </div>
                <div class="point">
          ...
          <div class="small-case  add-margin-left">
              <span class="tab-headding">Case.3</span>
              <div class="wrap-achieve-contents">
                  <h4  class="small-headding">
                    採用HP開設1年で新人スタッフ10名採用！
                  </h4>
                  <p>
                    美容業のお客様
                  </p>
...
<?php else : ?>
    ...
    <div class="wrapbrown">
        ...
        <div class="contentsbody">
            ...
            <div class="box trouble ratiofix">
                <div class="innerbox">
                    <img alt="" src="<?php bloginfo('template_url')?>/images/nakamoto_okomari1.png" >
                </div>
                    <p>
                        マーケティングをしたことが<br>ないから集客に自信がない
                    </p>
            </div>
            <div class="box trouble ratiofix">
                <div class="innerbox">
                    <img alt="" src="<?php bloginfo('template_url')?>/images/nakamoto_okomari2.png" >
                </div>
                    <p>
                        どんなサイトをつくったらいいか<br>わからない
                    </p>
            </div>
            <div class="box trouble ratiofix">
                <div class="innerbox">
                    <img alt="" src="<?php bloginfo('template_url')?>/images/nakamoto_okomari3.png" >
                </div>

                    <p>
                        コンサルを入れるほどではないが<br>Webマーケティングを強化したい
                    </p>
            </div>
            <div class="box trouble ratiofix">
                <div class="innerbox">
                    <img alt="" src="<?php bloginfo('template_url')?>/images/nakamoto_okomari4.png">
                </div>
                    <p>
                        多少の更新で<br>いちいちお金を取られる
                    </p>
            </div>
            <div class="box trouble ratiofix">
                <div class="innerbox">
                    <img alt="" src="<?php bloginfo('template_url')?>/images/nakamoto_okomari5.png" >
                </div>
                    <p>
                        もっと売り上げを<br>伸ばしたい
                    </p>
            ...
            <div class="box trouble ratiofix">
                <div class="innerbox">
                    <img alt="" src="<?php bloginfo('template_url')?>/images/nakamoto_okomari6.png" >
                </div>
                    <p>
                        広告に向いたサイトを<br>作りたい
                    </p>
...
<section  id="features">
    ...
    <?php if (wp_is_mobile()): ?>
        <div class="contentsbody">
            ...
            <div class="box row1 servicebox">
                <h4 class="tokutyouheadding"><span class="tokutyouspan">2.</span>Webマーケティング標準装備</h4>
            ...
            <div class="box row1 servicebox">
                <h4 class="tokutyouheadding"><span class="tokutyouspan">3.</span>開発時SEO対策標準装備</h4>
    ...
    <?php else: ?>
        <div class="contentsbody">
            <div class="tokutyoudiv">
                <div class="box70">
                    <h4 class="tokutyouheadding"><span class="tokutyouspan">1.</span>受注率特化！リスティング広告にも最適！</h4>
            ...
            <div class="tokutyoudiv">
                <div class="box70">
                    <h4 class="tokutyouheadding"><span class="tokutyouspan">3.</span>SEO対策標準装備！</h4>
            ...
            <div class="tokutyoudiv">
                ...
                <div class="box70">
                    <h4 class="tokutyouheadding"><span class="tokutyouspan">4.</span>更新サポート標準装備！</h4>
                    <p class="tokutyoup">更新サポートを標準装備しておりますので、納品後も安心です。文言の変更など小さな変更もご対応致します。</p>
                </div>
            </div>
            <div class="tokutyoudiv">
                <div class="box70">
                    <h4 class="tokutyouheadding"><span class="tokutyouspan">5.</span>経営コンサル不要！圧倒的費用対効果！！</h4>
...
<section id="reason">
    <div class="wrapbrown">
        ...
        <div class="formcontentsbody">
            ...
            <div class="box70">
                <p class="voiceheading">今後のトレンドは！？</p>
                <p>
        ...
        <div class="contentsbody">
                ...
                <table class="plantable" style="margin-bottom: 0;">
                    ...
                    <tr>
                        ...
                        <td class="standardplan abst">
                            ...
                            <br>ex)法律事務所、自動車販売会社、英会話スクール等
                        </td>
                        <td class="abst">
                            デザイン重視のサイト、まとめサイト・バズサイトなど、独自の仕様にカスタマイズしたい方用のプラン</td>
                        <td class="abst">リスティング広告で商品を売ることに特化した、一枚仕立てのランディングページを作りたい方用のプラン</td>
                    </tr>
                    ...
                    <tr>
                        <th>デザインページ</th>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"></td><td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"></td><td class="standardplan">トップページ１枚</td><td>カスタム</td><td>―</td>
                    </tr>
                    <tr>
                        <th rowspan="7" class="th_vertical" style="background:#1b0bbf;">標準装備</th>
                        <th>月々更新サポート</th>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td>
                    ...
                    <tr>
                        ...
                        <th>Wordpress実装</th>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+5,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td><td>―</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+5,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+5,000円)</small></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"><br><small>※</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td><td>―</td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>ランディングページを<br>トップページに追加</th>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+130,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+130,000円)</small></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+130,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td><td>―</td>
                    </tr>
                    <tr>
                        <th>カスタムバナー</th>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+5,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+5,000円)</small></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+5,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td><td>―</td>
                    </tr>
                    <tr>
                        <th>カスタムコンテンツ</th>
                    ...
                    <tr>
                        <th rowspan="6" class="th_vertical" style="background:#1b0bbf;">競合に差をつける</th>
                        <th>戦略Pro(個別戦略立案)</th>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+50,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+50,000円)</small></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+50,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td><td>―</td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+20,000円/1ページ)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+20,000円/1ページ)</small></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+20,000円/1ページ)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td><td>―</td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+20,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+20,000円)</small></td>
                        <td class="standardplan"><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(+20,000円)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/circlemark.png"></td><td>―</td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(個別相談)</small></td>
                        <td><img alt="" src="<?php bloginfo('template_url');?>/images/crossmark.png"><br><small>(個別相談)</small></td>
                    ...
                    <tr>
                        ...
                        <td class="standardplan" style="font-weight:bold;font-size:1.2rem;">
                            ＋0円
                        </td>
                        <td style="font-weight:bold;font-size:1.2rem;">
                            ＋0円
                    ...
                    <tr>
                        ...
                        <td style="font-weight:bold;font-size:1.2rem;">20,000円</td>
                        <td style="font-weight:bold;font-size:1.2rem;">20,000円/5p</td>
                        <td class="standardplan" style="font-weight:bold;font-size:1.2rem;">20,000円/5p</td>
                        <td style="font-weight:bold;font-size:1.2rem;">20,000円/5p</td>
                        <td style="font-weight:bold;font-size:1.2rem;">20,000円</td>
                    </tr>
                    <tr>
                        ...
                        <td class="standardplan" style="border-bottom:3px solid #E80076;font-weight:bold;font-size:1.2rem;">30,000円/5p</td>
                        <td style="font-weight:bold;font-size:1.2rem;">30,000円/5p</td>
                        <td style="font-weight:bold;font-size:1.2rem;">30,000円</td>
                    </tr>
                </table>
          ...
          <?php else:?>
              ...
              <p>
                ...
                <img id="slide" class="slide-image" src="<?php bloginfo('template_url');?>/images/tableimg.svg" alt="表リンク" >
                <p id="close" class="close-button">
                  Close
                </p>
              <div id="target" class="target-toggle">
                <img src="<?php bloginfo('template_url');?>/images/tableimg-expand.png" alt="拡大表画像" >
              </div>
          <?php endif;?>
                ...
                <div class="tablewrap">
                    <div class="small-case">
                        <table class="plantable">
                            ...
                            <tr>
                                <th>
                                    マーケティングに関する<br>メール / LINE<br>コンサルティング
                                </th>
                                <td>
                                    月5,000円〜
                                </td>
                    ...
                    <div class="small-case add-margin-left">
                        <table class="plantable">
                            ...
                            <tr>
                                <th>
                                    安心パックPro<br>(月に修正10箇所無料)<br><small>※作業時間3時間相当、<br>バナー制作は対象外</small>
                                </th>
                                <td>
                                    月9,800円〜
                                </td>
...
<section id="flow">
    <div class="wrapbrown">
        <div class="contentsbody">
            ...
            <div class="box">
                <img alt="" src="<?php bloginfo('template_url');?>/images/1iraisousin.png">
            </div>
            <div class="box">
                <img alt="" src="<?php bloginfo('template_url');?>/images/2iraisousin.png">
            </div>
            <div class="box">
                <img alt="" src="<?php bloginfo('template_url');?>/images/3iraisousin.png">
            </div>
            <div class="box">
                <img alt="" src="<?php bloginfo('template_url');?>/images/4iraisousin.png">
            </div>
            <div class="box">
                <img alt="" src="<?php bloginfo('template_url');?>/images/5iraisousin.png">
            </div>
            <div class="box">
                <img alt="" src="<?php bloginfo('template_url');?>/images/6iraisousin.png">
            </div>
        ...
        <div class="contentsbody">
            ...
            <div class="qa">
                ...
                <div class="qa">
                    ...
                    <div class="answer">
                        <p>
                            マーケティングの相談からデザインに関するご要望まで、弊社の過去の実績を元に、貴社に最適なサイトをご提案致します。販売数・受注率の向上にコミットしてご相談を承ります。
                        </p>
                    </div>
                </div>
        </div>
